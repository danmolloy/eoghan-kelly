    ...
    <div className="flex flex-col ">
      ...
      <div className="flex flex-col md:flex-row-reverse justify-evenly items-center">
        <div className="flex items-center m-4">
            ...
            <Image  alt="Eoghan Kelly" width={400} height={400} src={"https://fillmurray.lucidinternets.com/g/400/400"}/>
        </div>
      <div className="md:w-[50vw]">
        ...
        <p>Praesent auctor libero eget semper fermentum. Nunc cursus nisl sit amet justo dictum porta. Pellentesque faucibus cursus suscipit. Morbi hendrerit placerat mi, et molestie est tristique sit amet. In sed diam ut nisl finibus finibus. Proin nec justo vel risus aliquam hendrerit et in dolor. Donec finibus, elit et egestas commodo, tortor massa facilisis libero, hendrerit dapibus orci neque ac odio.</p>
        <p>Nulla facilisi. Maecenas nec iaculis ligula. Fusce vel vehicula velit, eget euismod justo. Etiam at eleifend metus. Mauris pellentesque vestibulum ante sit amet facilisis. Proin vel mollis turpis, vel ornare nisl. Vestibulum tincidunt nibh ut erat vehicula sodales. Vestibulum pharetra gravida quam, vitae dapibus tortor dictum sed. Etiam eu leo scelerisque, viverra urna vitae, posuere orci. Suspendisse vehicula dictum metus. Integer tortor sapien, sollicitudin vel augue vitae, blandit fringilla mi. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam erat volutpat. In hac habitasse platea dictumst.</p>
        <p>Suspendisse tincidunt mauris eu dictum tristique. Pellentesque in quam quis risus consequat auctor ac at justo. Morbi et cursus turpis, id luctus ante. Class.</p>
      </div>
      </div>
    </div>
  )
